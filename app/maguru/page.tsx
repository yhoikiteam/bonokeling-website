      ...
      <div className="md:flex">
        ...
        <div className="p-5 flex flex-col justify-between">
          <div className="mb-3">
            ...
            <p className="mt-2 text-gray-300 text-sm line-clamp-3">{article.excerpt}</p>
          </div>

          <div className="flex items-center justify-between text-xs text-gray-400 mt-4 pt-3 border-t border-[#8B5E3C]/50">
            <div className="flex items-center gap-3">
              <span>
                Oleh: <span className="text-[#D4A373] font-medium">{article.author}</span>
              </span>
        ...
        <div className="flex flex-wrap gap-2">
          <button
            ...
            className={`text-sm font-medium px-4 py-1 rounded-full transition-colors shadow-md ${
              activeTag === "" ? "bg-[#D4A373] text-black font-semibold" : "bg-[#3b2a1a] text-gray-200 hover:bg-[#D4A373]/70"
            }`}
          >
            Semua
          </button>
          {popularTags.map((tag) => (
            <button
              ...
              className={`text-sm font-medium px-4 py-1 rounded-full transition-colors shadow-md ${
                activeTag === tag ? "bg-[#D4A373] text-black font-semibold" : "bg-[#3b2a1a] text-gray-200 hover:bg-[#D4A373]/70"
              }`}
            >
              {tag}
            </button>
...
export default function MaguruPage() {
  ...
  const easing: Easing = [0.42, 0, 0.58, 1]; // cubic-bezier array
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div variants={containerVariants} initial="hidden" animate="visible">
            ...
            <motion.div variants={itemVariants} className="text-center mb-16">
              ...
              >
                <Image src="/images/iconbola/1.png" alt="Maguru Icon" layout="fill" objectFit="contain" />
              </motion.div>
            ...
            <motion.div variants={itemVariants} className="grid grid-cols-1 lg:grid-cols-3 gap-12">
              <div className="lg:col-span-2 space-y-8">
                {filteredArticles.length > 0 ? (
                  ...
                  <motion.div
                    variants={itemVariants}
                    className="text-center p-10 bg-black/50 rounded-xl border border-[#D4A373]/50"
                  >
